...
class StreetsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create street" do
    assert_difference("Street.count") do
      post streets_url, params: { street: { city: @street.city, name: @street.name, state: @street.state, zip: @street.zip } }
    end
  ...
  test "should update street" do
    patch street_url(@street), params: { street: { city: @street.city, name: @street.name, state: @street.state, zip: @street.zip } }
